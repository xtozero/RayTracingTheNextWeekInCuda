...
public:
	...
	__device__ virtual bool Scatter( curandState_t* randState, const Ray& inRay, const HitRecord& rec, Color& attenuation, Ray& scattered ) const override
	{
		...
		scattered = Ray( rec.m_hitPosition, scatteredDir );
...
public:
	...
	__device__ virtual bool Scatter( curandState_t* randState, const Ray& inRay, const HitRecord& rec, Color& attenuation, Ray& scattered ) const override
	{
		...
		scattered = Ray( rec.m_hitPosition, reflected + m_fuzz * RandomInUnitSphere( randState ) );
		attenuation = m_albedo;
...
public:
	...
	__device__ virtual bool Scatter( curandState_t* randState, const Ray& inRay, const HitRecord& rec, Color& attenuation, Ray& scattered ) const override
	{
		...
		scattered = Ray( rec.m_hitPosition, direction );
		return true;
	}
